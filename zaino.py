...
▀▄▄▄▄▄▀▄▀▄▀▄▄▀▄▄▀▄▄▀▄▄▀▄▄▄▄▄▀▄▄▄▄▄▀▄▄▄▄▀▀
  ...
  \033[1;96m:▒▒▒▒▒▒\033[1;93m+923096900124\033[1;96m▒▒▒▒▒▒▒▒▒▒▒:::::\033[1;92m♡
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Z.creations-\033[1;95m♡╭────•◈•───╮♡
\033[1;92m....................Z.creations......................
\033[1;96m╔═══╗──╔╗─────╔╗
\033[1;96m║╔═╗║──║║────╔╝╚╗
\033[1;96m║╚═╝╠══╣║╔╦╦═╩╗╔╬══╦═╗
\033[1;96m║╔══╣╔╗║╚╝╬╣══╣║║╔╗║╔╗╗
\033[1;96m║║──║╔╗║╔╗╣╠══║╚╣╔╗║║║║ 🇵🇰 ZINDABAD Z A I N   V.202☠️
\033[1;96m╚╝──╚╝╚╩╝╚╩╩══╩═╩╝╚╩╝╚╝
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mZ.creations\033[1;95m♡╰─────•◈•────╯♡"""
...
\033[1;92m
\033[1;92m
   \033[1;92m███████▒▒Welcome To Z.creations▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mZ.Creations\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mZAIN AHMED
\033[1;94mSHAKEEB\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mZAIN AHMED
\033[1;94mWhatsapp\033[1;91m: \033[1;91m03096900124
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mS.CREATIONS\033[1;95m♡╰───•◈•───╯♡"""
jalan('    \033[1;96m............ZAIN AHMED.CREATIONS...............:')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Zain_Hunter
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://youtu.be/FWagQXc4j-Y')
    else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mZ.creations\033[1;95m♡─────•◈•───♡"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Zain_Hunter
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mZ.creations\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By Z A I N r---•◈•---»" #Dev:ZAIN_HUNTER
	...
	print """
            ...
            ╚════════════════╝
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Z A I N  AHMED   Z.creations............ \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923096900124👈"""
